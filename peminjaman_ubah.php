        ...
        <div class="col-md-12">
            <form method="post">
                ...
                if(isset($_POST['submit'])) {
                    ...
                    $tanggal_peminjaman = $_POST['peminjaman'];
                    $tanggal_pengembalian = $_POST['peminjaman'];
                    $status_peminjaman = $_POST['Status_peminjaman'];
                    $query = mysqli_query($koneksi, "UPDATE peminjaman set BukuID='$BukuID', tanggal_peminjaman='$tanggal_peminjaman', tanggal_pengembalian='$tanggal_pengembalian', status_peminjaman='$status_peminjaman' WHERE PeminjamanID=$id");
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <input type="date" class="form-control" value="<?php echo $data['Tanggal_peminjaman']; ?>" name="peminjaman">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-2">Tanggal Pengembalian</div>
                    <div class="col-md-8">
                        <input type="date" class="form-control" value="<?php echo $data['Tanggal_pengembalian']; ?>" name="peminjaman">
                    </div>
                </div>
                <div class="row mb-3">
