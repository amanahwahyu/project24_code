                                    ...
                                    <div class="card-body">
                                        <?php
                                            if(isset($_POST['register'])) {
                                                ...
                                                $insert = mysqli_query($koneksi, "INSERT INTO user(email,nama_lengkap,alamat,no_telepon,username,password,level) VALUES('$email','$nama_lengkap','$alamat','$no_telepon','$username','$password','$level')");
